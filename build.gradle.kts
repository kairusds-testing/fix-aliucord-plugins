...
subprojects {
    ...
    aliucord {
        author("discorduser", 123456789L)
        updateUrl.set("https://raw.githubusercontent.com/kairusds-testing/fix-aliucord-plugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/kairusds-testing/fix-aliucord-plugins/builds/%s.zip")
    }
